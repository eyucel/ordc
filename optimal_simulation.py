...
def report2():
    ...
    f2.savefig("n_desc_units_a"+str(a)+".pdf",bbox_inches='tight')
    ax = f3.gca()
    handles, labels = ax.get_legend_handles_labels()
    ax.legend(handles, labels, loc=0)
    ax = f4.gca()
    handles, labels = ax.get_legend_handles_labels()
    ax.legend(handles, labels, loc=0)
    f4.savefig("n_desc_bf_a"+str(a)+".pdf",bbox_inches='tight')
    ax = f5.gca()
    handles, labels = ax.get_legend_handles_labels()
    ax.legend(handles, labels, loc=0)
    # f5.savefig('n_desc_avg_price.pdf')
    f5.savefig("n_desc_price_a"+str(a)+".pdf",bbox_inches='tight')
    ax = f6.gca()
    handles, labels = ax.get_legend_handles_labels()
    ax.legend(handles, labels, loc=0)
